...
best_student = Student('Ruoy', 'Jons', 'your_gender')
best_student.courses_in_progress += ['Python', 'Git']
best_student.finished_courses += ['Введение в программирование']

notbest_student = Student('Sam', 'Dodo', 'male')
notbest_student.courses_in_progress += ['Python', 'Git']
notbest_student.finished_courses += ['Введение в программирование']

cool_lecturer = Lecturer('Tony', 'Stark')
cool_lecturer.courses_attached += ['Python']

notcool_lecturer = Lecturer('Beny', 'Boom')
notcool_lecturer.courses_attached += ['Python']

cool_reviewer = Reviewer('Jay', 'Z')
cool_reviewer.courses_attached += ['Python']

notcool_reviewer = Reviewer('Arturo', 'Gatti')
notcool_reviewer.courses_attached += ['Python']

cool_reviewer.rate_hw(best_student, 'Python', 10)
cool_reviewer.rate_hw(best_student, 'Python', 7)

cool_reviewer.rate_hw(notbest_student, 'Python', 10)
